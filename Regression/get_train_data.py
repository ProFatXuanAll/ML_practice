def path(path = None):
    ...
    I tried to read file and format it base on day and hour:
        data[ some_day_some_hour ] = (AMB_TEMP, CH4, CO, ..., WIND_SPEED, WS_HR)
    ...
    while True:    
        ...
        # format each day, make a single data set by hour 
